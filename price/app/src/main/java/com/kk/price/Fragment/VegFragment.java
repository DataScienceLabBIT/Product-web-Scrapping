...
public class VegFragment extends Fragment {
    ...
    String click;
    FirebaseRecyclerAdapter<VegModel, veg_viewholder> firebaseRecyclerAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        try {
            ...
            DatabaseReference reference = firebaseDatabase.getReference("Data").child("Vegtables").child(click);
            FirebaseRecyclerOptions<VegModel> options = new FirebaseRecyclerOptions.Builder<VegModel>()
                    .setQuery(reference, VegModel.class).build();

            firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<VegModel, veg_viewholder>(options) {
                ...
                @Override
                protected void onBindViewHolder(@NonNull @NotNull veg_viewholder holder, int position, @NonNull @NotNull VegModel model) {
                    ...
                    holder.setdetails(getContext(), model.getVegetableName(), model.getMarketPrice(), model.getRetailPrice(), model.getShoppingMall(), model.getImg());
